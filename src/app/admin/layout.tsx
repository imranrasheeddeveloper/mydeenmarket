...
const navItems = [
  ...
  { label: "Newsletter", href: "/admin/newsletter", icon: "M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5H4.5A2.25 2.25 0 002.25 6.75m19.5 0v.243a2.25 2.25 0 01-.97 1.854l-7.5 5.143a2.25 2.25 0 01-2.56 0L3.22 8.847a2.25 2.25 0 01-.97-1.854V6.75" },
  { label: "Backups", href: "/admin/backups", icon: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M7.5 10.5L12 15m0 0 4.5-4.5M12 15V3" },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[calc(100vh-200px)]">
      {/* Sidebar */}
      <aside className="hidden lg:flex w-64 bg-gray-950 text-white flex-col shrink-0">
        <div className="p-5 border-b border-gray-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">MyDeenMarket</p>
            </div>
          </div>
        </div>
      ...
      {/* Mobile Nav */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 px-2 py-1.5">
      ...
      <div className="flex-1 bg-gray-50 overflow-y-auto">
        ...
        <div className="p-6 lg:pb-6 pb-20">
          {children}
        </div>
      </div>
    </div>
